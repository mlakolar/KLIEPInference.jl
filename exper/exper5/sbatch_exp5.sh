...
parallel --delay .2 -j $SLURM_NTASKS --joblog __$SLURM_JOB_NAME.runtask.log --resume srun --exclusive -N1 -n1 $ERR $OUT /project2/mkolar/julia-1.5.0/bin/julia experiment5.jl ${2} ${3} ${4} ${5} {1} ${6} ::: {1..1000}
